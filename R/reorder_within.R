...
#' \url{https://trinkerrstuff.wordpress.com/2016/12/23/ordering-categories-within-ggplot2-facets/} and 
#' David Robinson's Personal R Package \url{https://github.com/dgrtwo/drlib}
#'
#' @examples
#'
#' library(tidyr)
